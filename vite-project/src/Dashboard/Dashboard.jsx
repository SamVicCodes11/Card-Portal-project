  ...
  return (
    <div className="dashboard">
      ...
      <div className="quick-access">
        {['Manage a Card', 'Issue Instant Card', 'Issue Personalized Card', 'Review Card Requests'].map((item) => (
      ...
      <div className="analytics">
        {[
          ...
          { title: 'Total Personalized Cards', value: '15,703', growth: '+8.5%' },
          ...
          <div key={index} className="card">
            <h3>{card.title}</h3>
            <p>{card.value}</p>
            {card.growth && <span className="growth">{card.growth} this month</span>}
            {card.attention && <span className="attention">Requires attention</span>}
          </div>
        ))}
      </div>
